...
*/
console.log("the artist at index 3 is named " + getArtistByIndex(artists, 3));
...
console.log("20th Centry: " + get20s(artists));
function get20s(array){
      ...
      for (let i = 0; i < array.length; i++) {
          ...
          if(years[0] >= 1900 && years[1] <= 2000 ) {
              correctArray.push(array[i].name);
          }
        }
      return correctArray
...
*/
//artists = removeArtist(artists, 0);
//artists = removeArtist(artists, 0);
...
console.log(addArtist(artists, {
  "id": 20,
  "name": "Clayton Loneman",
  "years": "2001 - 2019",
  "genre": "Web Design",
  "nationality": "America",
  "bio": "A supreme artist from nebraska. No one can top his skills.",
  "wikipedia": "http://en.wikipedia.org/wiki/Clayton_Loneman",
  "paintings": 0
}))
